...
### Completed
The terminal Form state, entered once every core indicator is scored. Completion locks the scores: a Completed Form can no longer be edited, and in any sync conflict the server's copy of a Completed Form is authoritative.
